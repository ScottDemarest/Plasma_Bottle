...
_test_mode = True
smilei_version='4.7-236-ge13892daa-master'
smilei_mpi_size = 1
...
xx = np.linspace(0, Lx, int(Nx)-1)
yy = np.linspace(0, Ly, int(Ny)-1)
...
field_profile = {'Bx_m': Bx, 'By_m': By}

for field in ['Bx_m', 'By_m']:
    PrescribedField(
        field=field,
